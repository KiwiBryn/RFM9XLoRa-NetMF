...
//
//---------------------------------------------------------------------------------
namespace devMobile.IoT.NetMF.Rfm9X.EnumsAndMasks
{
   using System;
   ...
   public sealed class Rfm9XDevice
   {
      ...
      public Rfm9XDevice(Cpu.Pin chipSelect, Cpu.Pin resetPin, Cpu.Pin interruptPin)
      {
         ...
         byte syncWord = RegSyncWordDefault )
		{
         ...
         Rfm9XLoraModem.WriteByte(0x40, 0x00); // RegDioMapping1 0b00000000 DI0 RxReady & TxReady
      ...
      public class Program
      {
         public static void Main()
         {
            ...
            rfm9XDevice.Initialise(RegOpModeMode.ReceiveContinuous, 915000000, paBoost:true );
