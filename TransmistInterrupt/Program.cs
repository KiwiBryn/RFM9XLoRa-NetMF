...
namespace devMobile.IoT.NetMF.Rfm9X.TransmistInterrupt
{
   ...
   public sealed class Rfm9XDevice
   {
      ...
      void InterruptPin_OnInterrupt(uint data1, uint data2, DateTime time)
      {
         ...
         {
            this.RegisterWriteByte(0x01, 0x85); // RegOpMode 
            Debug.Print("Transmit-Done");
         }

         this.RegisterWriteByte(0x40, 0x0); // RegDioMapping1 
      ...
      public class Program
      {
         public static void Main()
         {
            ...
            while (true)
            {
               ...
               // Interrupt on TxDone
               rfm9XDevice.RegisterWriteByte(0x40, 0x0); // RegDioMapping1 0b00000000 DI0 TxDone
